                    ...
                    <header class="panel-heading bg-primary">
                      ...
                      <div class="widget-profile-info">
                        <div class="profile-picture">
                          <img src="{{ asset('/public/assets/images/!logged-user.jpg')}}">
                        </div>
                        ...
                        <li>
                          <div class="tm-box">
                            ...
                            <div class="thumbnail-gallery">
                              <a class="img-thumbnail lightbox" href="{{ asset('/public/assets/images/projects/project-4.jpg')}}" data-plugin-options='{ "type":"image" }'>
                                <img class="img-responsive" width="215" src="{{ asset('/public/assets/images/projects/project-4.jpg')}}">
                                <span class="zoom">
