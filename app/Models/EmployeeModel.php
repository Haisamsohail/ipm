...
class EmployeeModel extends Connection
{
	...
	public function AddEmployeeDB($Datarequest)
	{
        $AddactivityDBCallAPI = app(HttpClientCommunication::class);
		$response = $AddactivityDBCallAPI->storeData(self::END_POINT_USER."AddEmployeeDB", $Datarequest, true);
    ...
    public function EmployeeList($companyid,$branchid)
    {
        ...
        $response = $ActivityListCallAPI->storeData(self::END_POINT_USER."EmployeeList", $data, true);
        return $response->body();
    }
